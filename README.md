...
## 程式語言真的需要學嗎？
   ...
   我認為真正的重點在於「需求」，我也可以完全不需要英文，在台灣生活確實是用不到，程式語言也是一樣，現今各種性化的工具，就算不需要寫程式，一樣可以完成很多工作。不過對於現在這個大數據的時代、資訊發展迅速，資料在依般人眼中只是一串又一串的數字，對我們來說，病例是一個個活潑的生命，但是看起來卻只是一堆表格和數據，病例的增加可能會讓分析和觀察變得更加困難，這時程式語言絕對是最好的選擇。
