...
-   $\Omega = \{$ <i class="fa-solid fa-dice-one"></i> $,$ <i class="fa-solid fa-dice-two"></i> $,$ <i class="fa-solid fa-dice-three"></i> $,$ <i class="fa-solid fa-dice-four"></i> $,$ <i class="fa-solid fa-dice-five"></i> $,$ <i class="fa-solid fa-dice-six"></i> $\}$
